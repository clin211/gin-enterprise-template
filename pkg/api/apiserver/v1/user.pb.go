...
// 已弃用：请使用 User.ProtoReflect.Descriptor 代替。
...
// 已弃用：请使用 LoginRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 LoginResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 RefreshTokenRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 RefreshTokenResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 ChangePasswordRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 ChangePasswordResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 CreateUserRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 CreateUserResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 UpdateUserRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 UpdateUserResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 DeleteUserRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 DeleteUserResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 GetUserRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 GetUserResponse.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 ListUserRequest.ProtoReflect.Descriptor instead.
...
// 已弃用：请使用 ListUserResponse.ProtoReflect.Descriptor instead.
